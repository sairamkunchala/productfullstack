  ...
  return (
    ...
    <div style={{marginTop: "100px"}} className='signContainer'>
      ...
      <form onSubmit={handleSubmit} className='formContainer'>
         ...
         <input type='text' id='email' name='email' placeholder='Enter your email'  onChange={handleInputChange} />
         <label htmlFor='mobilenumber'>Moblie</label>
         <input type='text' name='mobilenumber' id='mobilenumber' placeholder='Enter your mobilenumber' onChange={handleInputChange} />
         <label htmlFor='password'>password</label>
         <input type='text' name='password' id='password' placeholder='Enter your password'  onChange={handleInputChange} />
